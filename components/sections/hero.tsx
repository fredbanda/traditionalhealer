          ...
          <div className="flex flex-col md:flex-row -mx-4">
            ...
            <div className="md:flex-1 px-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                ...
                work?{" "}Get  help to day and let him or her commit tomorrow. {" "}
              </p>
              ...
              <div>
                ...
                So you don&apos;t trust a Sangoma right because your friends say so? Your friends got everything going well for 
                      them right? What if they consulted a sangoma would they tell you? I can help you with the following:
                   Attract a new lover or just Heal an addiction. Know the future & Remove bewitchment & bad luck .Make more money or want to Communicate
                   with your ancestors.Protection against physical violence .Draw a ex-lover closer .Increase your personal wealth .Make your lover 
                  commit. Achieve your career goals .Infertility & sexual problems. Let&apos;s get started for the sake of your kids
                </p>
              </div>
            </div>
          </div>
