const Contact = () => {
  return (
    <>
      <div className="w-full px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="text-gray-700 mt-8">
              Hate forms? Send us a{" "}
              <span className="underline text-green-500">
                <a target="_BLANK" href="https://wa.me/27785000161">
                  WhatsApp Here
                </a>
              </span>
            </div>
